 ...
 */
class  QgsMapTool : public IC_QgsMapTool
{
  ...
  public:
    ...
    virtual void canvasMoveEvent( IC_QgsMapMouseEvent* e );

    //! Mouse double click event for overriding. Default implementation does nothing.
    virtual void canvasDoubleClickEvent( IC_QgsMapMouseEvent* e );

    //! Mouse press event for overriding. Default implementation does nothing.
    virtual void canvasPressEvent( IC_QgsMapMouseEvent* e );

    //! Mouse release event for overriding. Default implementation does nothing.
    virtual void canvasReleaseEvent( IC_QgsMapMouseEvent* e );
...
#else
	static double searchRadiusMU( IC_QgsMapCanvas * canvas );
#endif
signals:
#if QGSMAPCANVAS
    //! emit a message
...
#else
	//! emit a message
	//void messageEmitted( const QString& message, IC_QgsMessageBar::MessageLevel = IC_QgsMessageBar::INFO );
#endif
signals:
...
#else
QgsMapTool( IC_QgsMapCanvas* canvas );
#endif
