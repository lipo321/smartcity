 ...
 */
class QgsMapToolAdvancedDigitizing : public QgsMapToolEdit
{
    Q_OBJECT
  public:
  ...
  protected:
     ...
     */
    virtual void cadCanvasPressEvent( IC_QgsMapMouseEvent* e ) { Q_UNUSED( e ) }
     ...
     * @param e Mouse events prepared by the cad system
     */
    virtual void cadCanvasReleaseEvent( IC_QgsMapMouseEvent* e ) { Q_UNUSED( e ) }
     ...
     * @param e Mouse events prepared by the cad system
     */
    virtual void cadCanvasMoveEvent( IC_QgsMapMouseEvent* e ) { Q_UNUSED( e ) }
  ...
  private:
    ...
    void snap( IC_QgsMapMouseEvent* e );


protected:
    // Add by zhangyajun begin 2015/09/10
    // 鼠标按住状态
    bool mMousePressed;
    //IC_QgsMapCanvas *mCanvas;
    // end
};
