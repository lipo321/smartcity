...
class QgsMapToolCapture : public QgsMapToolAdvancedDigitizing
{
  ...
  public:
    //! constructor
    QgsMapToolCapture( IC_QgsMapCanvas* canvas, QgsAdvancedDigitizingDockWidget* cadDockWidget, CaptureMode mode = CaptureNone );
     ...
     */
    virtual void cadCanvasMoveEvent( IC_QgsMapMouseEvent * e ) override;
...
//    void currentLayerChanged( QgsMapLayer *layer );
  ...
  private:
    ...
    bool tracingMouseMove( IC_QgsMapMouseEvent* e );
  ...
  private:
    ...
    // Add bu zhangyajun begin 2015/09/10
    // 通过时间间隔流式采集点
    qint64 m_int64Time;

    static int m_iFlowTInterval;
    static int m_iFlowDInterval;
    // End
#ifdef Q_OS_WIN
