...
#else
QgsRubberBand::QgsRubberBand( IC_QgsMapCanvas* mapCanvas, QGis::GeometryType geometryType )
	: QgsMapCanvasItem( mapCanvas )
	, mIconSize( 5 )
	, mIconType( ICON_CIRCLE )
	, mGeometryType( geometryType )
...
QgsRubberBand::QgsRubberBand( IC_QgsMapCanvas* mapCanvas, bool isPolygon )
	: QgsMapCanvasItem( mapCanvas )
	, mIconSize( 5 )
	, mIconType( ICON_CIRCLE )
	, mTranslationOffsetX( 0.0 )
